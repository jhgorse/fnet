...
* @version 0.1.5.0
*
* @brief STM32F1 specific configuration file.
*
***************************************************************************/
...
#ifndef _FNET_STM32F1_CONFIG_H_
#define _FNET_STM32F1_CONFIG_H_
...
/*/ Smallest logical block which can be erased independently.*/ // TODO: Check F1
#define FNET_CFG_CPU_FLASH_PAGE_SIZE        (4*1024)        /* 4KB sector.*/

/* On-chip Flash size.*/ //
#define FNET_CFG_CPU_FLASH_SIZE             (256 * 1024)    /* Up to 256 kB */

#define FNET_CFG_CPU_FLASH_PROGRAM_SIZE     (8) /*Bytes.*/	// TODO: Check F1
